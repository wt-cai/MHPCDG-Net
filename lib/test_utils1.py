...
def save_point_cloud(pcd, rgb, hy_data,filename, binary=True):
    ...
    if hy_data != None:
        ...
        python_types = (float, float, float, int, int, int,float, float, float,float, float, float,float,float, float,float, float, float,float,
        ...
        # npy_types = [('x', 'f4'), ('y', 'f4'), ('z', 'f4'), ('red', 'u1'), ('green', 'u1'), ('blue', 'u1'),\
        #              ('1x', 'f4'), ('2y', 'f4'), ('3z', 'f4'),('4x', 'f4'), ('5y', 'f4'), ('6z', 'f4'),\
        #              ('7x', 'f4'), ('8y', 'f4'), ('9z', 'f4'),('10x', 'f4'), ('11y', 'f4'), ('12z', 'f4'),\
        #              ('13x', 'f4'), ('14y', 'f4'), ('15z', 'f4'),('16x', 'f4'), ('17y', 'f4'), ('18z', 'f4'), \
        #              ('19x', 'f4'), ('20y', 'f4'), ('21z', 'f4'),('22x', 'f4'), ('23y', 'f4'), ('24z', 'f4'),\
        #              ('25x', 'f4'), ('26y', 'f4'), ('27z', 'f4'),('28x', 'f4'), ('29y', 'f4'), ('30z', 'f4')  ]
        ...
        if binary is True:
            ...
            el = PlyElement.describe(vertices_array, 'vertex',comments=['vertices'])
...
def reconstruct_depth(depth, rgb,hy_data, dir, pcd_name, focal):
    ...
    save_point_cloud(pcd, rgb_n, hy_data,os.path.join(dir, pcd_name + '.ply'))
